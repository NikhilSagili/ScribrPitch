            ...
            "blocks": [
                {
                    ...
                    "competitors": [
                        {"name": "Cred / Fold", "desc": "Strong on dashboard & discovery, weak on merchant tools.", "data": [5, 3, 5, 1, 1, 2]},
                        {"name": "Razorpay / Juspay", "desc": "Payment infrastructure giants. Zero consumer interface.", "data": [1, 5, 1, 5, 2, 3]},
                        {"name": "Paytm / PhonePe", "desc": "Generic UPI apps. Good for mandates, bad for management.", "data": [2, 5, 2, 2, 1, 1]},
